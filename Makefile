...
imports: bin/goimports ## Update imports in Go source code
	bin/goimports -w -local github.com/spatialcurrent/go-try-get,github.com/spatialcurrent $$(find . -iname '*.go')

vet: ## Vet Go source code
	go vet github.com/spatialcurrent/go-try-get/pkg/... # vet packages
